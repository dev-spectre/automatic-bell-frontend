...
export const SCHEDULE_ASSIGNED: RawToast = {
  ...
  description: "Schedule has been assigned and the schedule is now active.",
  type: "info",
};
...
export const SCHEDULE_ASSIGNMENT_UPDATED: RawToast = {
  title: "Schedule assignment updated",
  description: "Schedules has been assignment has been updated.",
  type: "info",
};
