...
export function Register() {
  return (
    <div className="min-h-[100dvh] bg-corbeau-600 bg-gradient-to-b from-black to-corbeau-600 pt-10">
      <div className="container mx-auto items-center justify-center gap-10 px-5 md:flex md:justify-between xl:px-28">
        <div className="mb-5 max-w-2xl md:mb-0">
          <h1 className="text-center text-5xl font-medium md:text-left md:text-6xl lg:text-7xl">
            Bell Scheduler
          </h1>
